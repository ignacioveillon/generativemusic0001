...
function setup() {
  ...
  sawtoothButton.addEventListener('click', startSawtoothOscillator);
  stopSawtoothButton.addEventListener('click', stopSawtoothOscillator);
  triggerAllEnvelopesButton.addEventListener('click', triggerAllEnvelopes);
  triggerDecreaseEnvelopesButton.addEventListener('click', triggerDecreaseEnvelopes);
